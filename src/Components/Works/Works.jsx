  ...
  return (
    <section className="main container">
      ...
      <div className="works">
        ...
        />
        <Work
          link="https://artyom-voitas.github.io/rayal-park/"
          img={rayalPark}
          tech="HTML, CSS"
          time="Time: 24 hours"
        />
        <Work
          link="https://artyom-voitas.github.io/universal-store/build"
          img={universalStore}
          tech="Pug, SCSS, JS"
          time="8 hours"
        />
        <Work
          link="https://artyom-voitas.github.io/honey-store/"
          img={honeyStore}
          tech="HTML, CSS"
          time="12 hours"
        />
        <Work
          link="https://artyom-voitas.github.io/cv-template/"
          img={cvTemplate}
          tech="HTML, CSS"
          time="3 hours"
        />
        <Work
          link="https://artyom-voitas.github.io/product-page/"
          img={productPage}
          tech="HTML, CSS"
          time="2 hours"
        />
